...
% a localizacao desse ponto no início do procedimento 

function [PontaAgulha,Teta_A] = CorrecaoBin_inicial(diretorio)
...
P1_Y = PontaAgulha(2,1); % na direcao Y 
...
% title('Image needle angle step: pre-insertion');
% x =  0:0.5:900;
...
title('Image binary step: pre-insertion');
% plot(lowest_X,lowest_Y,'b.');
plot(P1_X,P1_Y,'r.');
% plot(P2_X,P2_Y,'r.');
% =================================
