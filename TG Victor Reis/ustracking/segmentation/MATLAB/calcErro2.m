...
%desconsidera primeiros 20 frames (ajuste inicial)
for i = 20:1:agulhaMet2Met1Met3_im_linhas
    % Filtro de Kalman
...
hold on;
xlabel ('Quadros');
ylabel ('Erro');str2 = sprintf ('Metodo 1: Erro medio = %0.1f Erro maximo = %0.1f',em2, emax2);
title (str2);
plot(t,e2);
